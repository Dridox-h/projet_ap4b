...
import com.trio.controller.TeamGameController;
...
public class MenuGUI extends JFrame {
    ...
    // === Apple-like Color Palette (matching SwingGameView) ===
    private static final Color BACKGROUND_DARK = new Color(248, 248, 248); // Apple light gray
    private static final Color BACKGROUND_MEDIUM = Color.WHITE; // White cards
    private static final Color ACCENT_BLUE = new Color(0, 122, 255); // Apple Blue
    private static final Color BUTTON_PRIMARY = new Color(0, 122, 255); // Apple Blue
    private static final Color BUTTON_PRIMARY_HOVER = new Color(0, 105, 217);
    private static final Color BUTTON_SECONDARY = new Color(0, 122, 255); // Apple Blue
    private static final Color BUTTON_SECONDARY_HOVER = new Color(0, 105, 217);
    ...
    private static final Color TEXT_PRIMARY = new Color(0, 0, 0); // Black
    private static final Color TEXT_SECONDARY = new Color(60, 60, 67, 153); // Gray with alpha
    private static final Color BORDER_COLOR = new Color(199, 199, 204); // Light gray border
    ...
    private void launchTeamGame(java.util.List<Player> players) {
        ...
        for (int i = 0; i < nbTeams; i++) {
            ...
            Team team = new Team("├ëquipe " + (char) ('A' + i), teamPlayers);
            teams.add(team);
        }
