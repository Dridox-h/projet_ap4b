...
import com.trio.model.Deck;
import com.trio.model.Menu;
import com.trio.model.Player;
import com.trio.model.SoloGame;
import com.trio.model.Team;
import com.trio.model.TeamGame;
...
public class MenuGUI extends JFrame {
    ...
    private static final Color BACKGROUND_DARK = new Color(26, 26, 46); // Deep navy
    private static final Color BACKGROUND_MEDIUM = new Color(30, 35, 60); // Slightly lighter navy
    private static final Color GLASS_PANEL = new Color(40, 45, 75, 200); // Glassmorphism effect
    private static final Color ACCENT_CYAN = new Color(0, 217, 255); // Electric cyan
    private static final Color ACCENT_PURPLE = new Color(139, 92, 246); // Vibrant purple
    private static final Color ACCENT_GREEN = new Color(16, 185, 129); // Success green
    private static final Color BUTTON_PRIMARY = new Color(0, 180, 216); // Cyan button
    private static final Color BUTTON_PRIMARY_HOVER = new Color(0, 210, 255);
    private static final Color BUTTON_SECONDARY = new Color(100, 80, 180); // Purple button
    private static final Color BUTTON_SECONDARY_HOVER = new Color(139, 92, 246);
    ...
    private static final Color BORDER_COLOR = new Color(80, 90, 130); // Subtle border
    ...
    private void startGame() {
        ...
        // Launch the game using test branch architecture
        java.util.List<Player> players = createPlayersForGUI();
        if (menu.getType().equals("Team")) {
            launchTeamGame(players);
        } else {
            launchSoloGame(players);
        }
    }
    ...
    private User selectExistingUser() {
        ...
        idField.setCaretColor(ACCENT_CYAN);
        ...
        GlowButton selectButton = new GlowButton("Select User", BUTTON_PRIMARY, BUTTON_PRIMARY_HOVER);
        ...
        GlowButton cancelButton = new GlowButton("Cancel", BUTTON_SECONDARY, BUTTON_SECONDARY_HOVER);
    ...
    private User createNewUser() {
        ...
        ageField.setCaretColor(ACCENT_CYAN);
        ...
        avatarField.setCaretColor(ACCENT_CYAN);
        ...
        GlowButton createButton = new GlowButton("Create User", BUTTON_PRIMARY, BUTTON_PRIMARY_HOVER);
    ...
    // Custom glowing button with gradient
    private static class GlowButton extends JButton {
        private Color baseColor;
        private Color hoverColor;
        private boolean isHovered = false;

        public GlowButton(String text, Color baseColor, Color hoverColor) {
            super(text);
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (isHovered) {
                g2.setColor(new Color(currentColor.getRed(), currentColor.getGreen(), currentColor.getBlue(), 50));
    ...
    public MenuGUI() {
        ...
        GlassPanel userInfoCard = new GlassPanel();
        userInfoCard.setLayout(new BoxLayout(userInfoCard, BoxLayout.Y_AXIS));
        userInfoCard.setBorder(BorderFactory.createEmptyBorder(25, 20, 25, 20));
        ...
        userNameDisplay.setForeground(ACCENT_CYAN);
        ...
        victoriesDisplay.setForeground(TEXT_SECONDARY);
        ...
        GlassPanel settingsDisplayCard = new GlassPanel();
        settingsDisplayCard.setLayout(new BoxLayout(settingsDisplayCard, BoxLayout.Y_AXIS));
        settingsDisplayCard.setBorder(BorderFactory.createEmptyBorder(25, 20, 25, 20));
        ...
        settingsInfo.setForeground(TEXT_SECONDARY);
        ...
        // --- Player Slider Card ---
        GlassPanel sliderCard = new GlassPanel();
        sliderCard.setLayout(new BoxLayout(sliderCard, BoxLayout.Y_AXIS));
        sliderCard.setBorder(BorderFactory.createEmptyBorder(25, 30, 25, 30));
        sliderCard.setMaximumSize(new Dimension(580, Integer.MAX_VALUE));
        ...
        playerSlider.setBackground(new Color(0, 0, 0, 0));
        playerSlider.setForeground(TEXT_PRIMARY);
        ...
        playerSlider.setUI(new BasicSliderUI(playerSlider) {
            ...
            public void paintThumb(Graphics g) {
                ...
                // Draw glow
                g2.setColor(new Color(0, 217, 255, 50));
            ...
            public void paintTrack(Graphics g) {
                ...
                GradientPaint gradient = new GradientPaint(
                        trackBounds.x, trackY, ACCENT_CYAN,
                        trackBounds.x + filledWidth, trackY, ACCENT_PURPLE);
                g2.setPaint(gradient);
        ...
        // --- Type Button ---
        GlassPanel typeCard = new GlassPanel();
        typeCard.setLayout(new BoxLayout(typeCard, BoxLayout.Y_AXIS));
        typeCard.setBorder(BorderFactory.createEmptyBorder(25, 30, 25, 30));
        typeCard.setMaximumSize(new Dimension(580, Integer.MAX_VALUE));
        ...
        // --- Action Buttons ---
        GlowButton startButton = new GlowButton("Start Game", ACCENT_GREEN, new Color(20, 200, 140));
        startButton.setPreferredSize(new Dimension(580, 55));
        startButton.setMaximumSize(new Dimension(580, 55));
        startButton.setAlignmentX(Component.CENTER_ALIGNMENT);
        startButton.addActionListener(e -> startGame());

        GlowButton botsButton = new GlowButton("Complete with Bots", BUTTON_SECONDARY, BUTTON_SECONDARY_HOVER);
        ...
        GlowButton createUserButton = new GlowButton("Create New User", BUTTON_PRIMARY, BUTTON_PRIMARY_HOVER);
        ...
        GlowButton selectUserButton = new GlowButton("Select a User", BUTTON_PRIMARY, BUTTON_PRIMARY_HOVER);
        ...
        GlowButton viewCardsButton = new GlowButton("View All Cards", new Color(255, 149, 0), new Color(255, 180, 50));
        viewCardsButton.setPreferredSize(new Dimension(580, 55));
        viewCardsButton.setMaximumSize(new Dimension(580, 55));
        viewCardsButton.setAlignmentX(Component.CENTER_ALIGNMENT);
        viewCardsButton.addActionListener(e -> showAllCards());

        GlowButton exitButton = new GlowButton("Exit", DANGER, new Color(250, 90, 90));
        ...
        mainContainer.add(Box.createRigidArea(new Dimension(0, 12)));
        mainContainer.add(viewCardsButton);
        mainContainer.add(Box.createRigidArea(new Dimension(0, 12)));
    ...
    /**
     * Affiche toutes les 36 cartes dans un dialog avec leurs couleurs et
     * coordonnées
     */
    private void showAllCards() {
        // Charger les cartes depuis DrawPile
        com.trio.model.DrawPile drawPile = new com.trio.model.DrawPile();
        drawPile.createDefaultCards();
        com.trio.model.Deck deck = drawPile.getDeck();

        // Créer le dialog
        JDialog cardsDialog = new JDialog(this, "Toutes les Cartes", true);
        cardsDialog.setSize(900, 700);
        cardsDialog.setLocationRelativeTo(this);
        cardsDialog.getContentPane().setBackground(BACKGROUND_DARK);
        ...
        // Titre
        JLabel titleLabel = new JLabel("Collection des 36 Cartes", SwingConstants.CENTER);
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 24));
        titleLabel.setForeground(ACCENT_CYAN);
        mainPanel.add(titleLabel, BorderLayout.NORTH);

        // Grille de cartes (12 colonnes x 3 lignes, groupées par valeur)
        JPanel cardsGrid = new JPanel(new GridLayout(3, 12, 8, 8));
        cardsGrid.setBackground(BACKGROUND_DARK);

        // Trier par valeur
        java.util.List<com.trio.model.Card> cards = deck.getCards();
        cards.sort((a, b) -> {
        ...
        for (com.trio.model.Card card : cards) {
        ...
        // Bouton Fermer
        GlowButton closeButton = new GlowButton("Fermer", BUTTON_PRIMARY, BUTTON_PRIMARY_HOVER);
        closeButton.setPreferredSize(new Dimension(150, 45));
        closeButton.addActionListener(e -> cardsDialog.dispose());
    ...
    /**
     * Crée un panneau de carte pour l'affichage dans le visualiseur
     */
    private JPanel createCardPanel(com.trio.model.Card card) {
        Color cardColor = getCardColor(card.getValue());
        ...
        panel.setPreferredSize(new Dimension(65, 90));
        ...
        // Coordonnée au centre
        JLabel coordLabel = new JLabel("<html><center>" + card.getCoordinate() + "</center></html>");
        coordLabel.setFont(new Font("Segoe UI", Font.BOLD, 8));
    ...
    private JButton createDropdownButton(String text) {
        JButton button = new GlowButton(text, BUTTON_SECONDARY, BUTTON_SECONDARY_HOVER);
    ...
    // Helper methods for game launching
    private java.util.List<Player> createPlayersForGUI() {
        java.util.List<Player> players = new java.util.ArrayList<>();

        // Add current user
        if (menu.getCurrentUser() != null) {
            players.add(menu.getCurrentUser());
        }

        // Add bots
        for (int i = 1; i < menu.getNbPlayers(); i++) {
    ...
    private void launchSoloGame(java.util.List<Player> players) {
        SoloGame game = new SoloGame(players, new Deck());
        SwingGameView gameView = new SwingGameView();
        com.trio.controller.GameController controller = new com.trio.controller.GameController(game, gameView);
    ...
    private void launchTeamGame(java.util.List<Player> players) {
        // Create teams
        ...
        com.trio.controller.TeamGameController controller = new com.trio.controller.TeamGameController(game, teamView);
